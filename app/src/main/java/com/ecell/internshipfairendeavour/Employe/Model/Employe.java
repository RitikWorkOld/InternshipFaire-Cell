...
public class Employe {
  ...
  public String desc_status;
    ...
    public Employe(String desc_status,String cmpid,String name, String email, String contactn, String eid, String password, String profileimg,String website, String profilestatus,String officialstatus,String descrip,String logostatus) {
        this.name = name;
        this.email = email;
